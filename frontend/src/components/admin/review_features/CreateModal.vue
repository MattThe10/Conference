...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                axios.post("/api/review_features", {
                ...
                .catch((error) => {
                    console.error("Chyba pri vytváraní otázky recenzie: ", error);
                    alert("Nepodarilo sa vytvoriť otázku recenzie.");
                });
            },
        },
    };
